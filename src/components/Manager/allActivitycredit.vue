                  ...
                  <div class="tab-content mainContent">
                     <div id="cerdit-card" class="tab-pane fade in active">
                      <div class="common-main-div">
                        <p class="backIcon" style="display: block;" @click="backMainScreen()"><i aria-hidden="true" class="fa fa-angle-left"></i></p>
                                ...
                                <table class="table table-bordered" >
                                        <thead>
                                          <tr>
                                            ...
                                            <th colspan="2" width="300px">Achieved Time</th>
