                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="calender-Div" @click="calenderBoxShow()">
                                    ...
                                    <span class="changeText" v-if="time1 !=null">{{time1}}</span>
                                    <span class="changeText" v-else>Month Over Month</span>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        ...
                                        <div class="from-Calender">
                                          <!-- <i class="fa fa-calendar" aria-hidden="true"></i>
                                          <span>06/10/20</span> -->
                                          <date-picker v-model="time1" valueType="format"  type="month" width='150px'></date-picker>
                                        </div>
                                      </div>
                                       <div class="col-lg-6">
                                        <label>To</label>
                                        <div class="from-Calender">
                                          ...
                                          <date-picker v-model="time2"  type="month"  valueType="format" width='150px'  @change="calenderBoxShow()"></date-picker>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row">
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="bar-Div">
                                          ...
                                          <thead>
                                            <tr>
                                              <th><span onclick="showWeekData()" class="downArrow" style="display: block;"><i class="fa fa-caret-up" aria-hidden="true"></i></span> Jan, 2020 <i class="fa fa-angle-down" aria-hidden="true"></i></th>
                                              <th>Trend</th>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="bar-Div">
                                          ...
                                          <thead>
                                            <tr>
                                              <th><span class="downArrow" style="display: block;"><i class="fa fa-caret-up" aria-hidden="true"></i></span>Fab ,2020 <i class="fa fa-angle-down" aria-hidden="true"></i></th>
                                              <th>Trend</th>
                                              <th>Average hrs per Employee</th>
                                              <th>Employee this Period</th>
                                              <th colspan="2">Assigned Time</th>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="bar-Div">
                                          ...
                                          <thead>
                                            <tr>
                                              <th><span class="downArrow" style="display: block;"><i class="fa fa-caret-up" aria-hidden="true"></i></span> March,2020 <i class="fa fa-angle-down" aria-hidden="true"></i></th>
                                              <th>Trend</th>
                                              <th>Average hrs per Employee</th>
                                              <th>Employee this Period</th>
                                              <th colspan="2">Assigned Time</th>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="bar-Div">
                                          ...
                                          <thead>
                                            <tr>
                                              <th><span class="downArrow" style="display: block;"><i class="fa fa-caret-up" aria-hidden="true"></i></span> April,2020 <i class="fa fa-angle-down" aria-hidden="true"></i></th>
                                              <th>Trend</th>
                                              <th>Average hrs per Employee</th>
                                              <th>Employee this Period</th>
                                              <th colspan="2">Assigned Time</th>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="bar-Div">
                                          ...
                                          <thead>
                                            <tr>
                                              <th><span class="downArrow" style="display: block;"><i class="fa fa-caret-up" aria-hidden="true"></i></span> May,2020 <i class="fa fa-angle-down" aria-hidden="true"></i></th>
                                              <th>Trend</th>
                                              <th>Average hrs per Employee</th>
                                              <th>Employee this Period</th>
                                              <th colspan="2">Assigned Time</th>
